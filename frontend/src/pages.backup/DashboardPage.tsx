    ...
    return (
        <div className="p-8 space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="bg-gradient-to-br from-primary/10 to-accent/10 border-primary/20 hover:border-primary/40 transition cursor-pointer"
                ...
                <Card className="bg-gradient-to-br from-accent/10 to-primary/10 border-accent/20 hover:border-accent/40 transition cursor-pointer"
                    onClick={() => navigate('/games')}>
                    <CardHeader>
                        <CardTitle className="flex items-center justify-between">
                            Configurations
                    ...
                    <CardContent>
                        ...
                        <p className="text-sm text-muted-foreground">Select a game to view</p>
                    </CardContent>
                </Card>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {games?.map((game) => (
                        <Card
                            ...
                            onClick={() => navigate(`/games/${game.id}/configs`)}
                        >
                            <CardHeader>
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-2 text-sm">
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-medium">{game.environments?.length || 0}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-muted-foreground">Firebase Project:</span>
                                        <span className="font-mono text-xs">{game.firebase_project_id}</span>
                                    </div>
                                </div>
